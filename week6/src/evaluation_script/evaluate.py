...
def evaluate(pred_gt,full_annotations):
    ...
    average_bias = (b_a+b_g+b_e)/3
    print("=======")
    print("Average bias = %.4f" % average_bias)
    print("=======")

    return avg_acc, avg_acc_per_age_cat, avg_acc_per_gender_cat, avg_acc_per_ethnicity_cat, average_bias, b_a, b_g, b_e
    

# if __name__ == '__main__': 
#     full_annotations = pd.read_csv(r'./test_set_age_labels.csv',sep = ',')
#     pretictions_with_gt = pd.read_csv(r'./InceptionResnetV1_38032_ 0.csv',sep = ',')

#     evaluate(pretictions_with_gt,full_annotations)
