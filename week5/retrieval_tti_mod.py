...
def evaluate_retrieval_tti(text_encoder, database_path: str, image_model: Union[str, nn.Module], text_model: Union[str, Path, nn.Module], embedding_size: int, config: Any):
    ...
    for entry in tqdm(database["annotations"]):
        ...
        if int(precision[0]) == 0:
            img_path = f'/ghome/group02/mcv/datasets/C5/COCO/val2014/COCO_val2014_{str(database["images"][indices[0][0]]["id"]).zfill(12)}.jpg'
            img = Image.open(img_path).convert('RGB')
            img.save(f"results/bad_retrievals/{caption}_{image_id}.jpg")
    ...
    # Save the plot as a PNG file
    plt.savefig(f'TSNE_plot/tsne_plot_TaskB.png')
...
if __name__ == "__main__":
    ...
    output_path = 'results/bad_retrievals'
    ...
    evaluate_retrieval_tti('BERT','/ghome/group02/C5-G2/Week4/captions_valsplit_1100.json', '/ghome/group02/C5-G2/Week5/weights/textimagenet36524_0_img.pth', '/ghome/group02/C5-G2/Week5/weights/textimagenet36524_0_txt.pth', 2048, config)
