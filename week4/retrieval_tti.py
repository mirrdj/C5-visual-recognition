...
if __name__ == "__main__":
    ...
    evaluate_retrieval_tti('BERT','/ghome/group02/C5-G2/Week4/captions_test_100.json', '/ghome/group02/C5-G2/Week4/weights/textimagenet35211_0_img.pth', '/ghome/group02/C5-G2/Week4/weights/textimagenet35211_0_txt.pth', 2048, config)
